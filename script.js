...
window.splashes = [
    ...
    "Around the world...",
    "🐟",
    "Making French bread is such a pain.",
    ...
    "You can have money or duck.<br>'Duck?'<br>Duck it is then.<br>'quack'",
    "The Second Dukemz.",
    "yo",
    ...
    "Turned himself into a duck, funniest stuff I've seen.",
